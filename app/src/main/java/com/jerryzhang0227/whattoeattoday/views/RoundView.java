...
public class RoundView extends androidx.appcompat.widget.AppCompatImageView {
    ...
    private void obtainStyledAttrs(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        currMode = a.hasValue(R.styleable.RoundView_type) ? a.getInt(R.styleable.RoundView_type, MODE_NONE) : MODE_NONE;
        currRound = a.hasValue(R.styleable.RoundView_radius) ? a.getDimensionPixelSize(R.styleable.RoundView_radius, currRound) : currRound;
        a.recycle();
    }
